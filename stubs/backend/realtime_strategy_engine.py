...
class RealtimeStrategyEngine:
    ...
    def get_status(self):
        return {'running': self._running, 'stock_code': self.stock_code, 'mode': 'demo', 'logs': list(self.logs[-50:])}
